            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        Internet paga <input <c:if test="${operacao == 'Excluir'}"> readonly</c:if> type='number' min="0" max="1" name='textInternet' size="2" value="<c:if test="${formularioSocioeconomico.internet}">1</c:if><c:if test="${!formularioSocioeconomico.internet}">0</c:if>"> <br>
